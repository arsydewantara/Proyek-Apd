        ...
        if kabupaten_pilihan == "1":
            ...
            if kategori_pilihan == "1":
                ...
                print(kutaikartanegara_kuliner)
                ...
                print(kutaikartanegara_keluarga)
                ...
                print(kutaikartanegara_sejarah)
            ...
            if kategori_pilihan == "1":
                ...
                if religi_berau == "1":
                    ...
                    print(" ")
                    print("Salah satu wisata sejarah makam di Berau")
                else: ulang()
